/*
package me.Bazza491.DungeonsLibrary.OldAttack;


import me.Bazza491.DungeonsLibrary.AttackType;
import me.Bazza491.DungeonsLibrary.DamageType;
import me.Bazza491.DungeonsLibrary.Die;
import me.Bazza491.DungeonsLibrary.Monster;
...
public class OldAttack {
    ...
    public OldAttack(String attackName, int numOfAttacks, int dieType, int dmgBonus, int attackBonus, DamageType damageType) {
    ...
    public OldAttack(String attackName, int dieVolume, int dieType, int attackBonus, DamageType damageType, String otherEffects) {
        this.attackName = attackName;
    ...
    public OldAttack(String attackName, int dieVolume, int dieType, int spellSaveDC, int saveProficiency, DamageType damageType, String otherEffects) {
        this.attackName = attackName;
        this.dieVolume = dieVolume;
        this.dieType = dieType;
        this.spellSaveDC = spellSaveDC;
        OldAttack.saveProficiency = saveProficiency;
        this.damageType = damageType;
        this.otherEffects = otherEffects;
